  ...
  return (
    <div style={storyStyles.container}>
      <div style={storyStyles.gradientHeader}>
        <h1 style={storyStyles.gradientHeaderTitle}>Multi-Instance Synchronization</h1>
      </div>
      ...
      >
        <strong>Note:</strong> Both instances automatically stay synchronized. Incrementing one will
        update the other in real-time.
      </div>
    </div>
  );
};
